...
<div class="container">
    ...
    <form action="<?php echo e(route('products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="price" id="price" class="form-control" step="0.01" value="<?php echo e(old('price', $product->price)); ?>" required>
        </div>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROGRAMMING\Web Programming\TUGAS BESAR WEBAPP\Millenniumworks\resources\views/products/edit.blade.php ENDPATH**/ ?>